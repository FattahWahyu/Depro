    ...
    <div className="w-full p-4 ">
      ...
      <div className="mb-4 md:col-span-2 overflow-hidden">
        <h1 className="font-inter">
          Download Mobile App untuk menikmati fitur lebih lengkap
        </h1>
      ...
      <a
        href="https://github.com/C23-GT01/android-app/releases/download/Final-Deliverables/trackmate-1.0.apk"
        className="block text-center bg-[#9f7451] text-white py-2 px-4 rounded-md w-full  hover:bg-[#05C6FB] md:col-span-2 mt-4"
      >
        Download Now!
      </a>
    </div>
